...
import img1 from '/Static Products/Watche/1.jpg'
import img2 from '/Static Products/Watche/2.jpg'
import img3 from '/Static Products/Watche/4.jpg'
  ...
  return (
    <section className="bg-transparent-100 py-12">
      ...
      <div className="text-start mb-8">
          <h2 className="text-3xl font-bold text-purple-800">Smart Watches</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="relative bg-white rounded-lg overflow-hidden shadow-md transform hover:scale-105 transition-transform duration-300">
            ...
            <Link to = "/smart-watches">Go to Shop</Link>
</button>
            </div>
          </div>
